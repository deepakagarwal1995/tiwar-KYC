...
<div class="row">
                    ...
                    <form action="{{ route('society.action') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="name" name="proposer" required >
                            </div>
                            @error('proposer')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="firstNameinput" class="form-label">Current  Address</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="firstNameinput" class="form-label">Permanent Address</label>
                                <input type="text" class="form-control" placeholder="Permanent Address" name="paddress" >
                            </div>
                            @error('paddress')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="Enter DOB" name="dob" >
                            </div>
                            @error('dob')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                                ...
                                                <select name="countryCode" class="selectmenu" style="width:25%">
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                ...
                                title="Phone number with 6-9 and remaing 9 digit with 0-9" placeholder="Enter Mobile" name="mobile" required >
                                 </div>
                            </div>
                            @error('mobile')
                            <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="firstNameinput" class="form-label">Documents (Aadhar/PAN)</label>
